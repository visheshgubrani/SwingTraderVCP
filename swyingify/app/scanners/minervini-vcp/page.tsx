...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    ...
    description:
      "Browse tonight’s Minervini Standard shortlist (top 25) for the Nifty 500. Independent Stage 2 / volatility contraction approximation after every close.",
      ...
      {board.isLiveData && board.results.length > 0 ? (
        <JsonLd
          data={scannerCollectionJsonLd({
            ...
            description:
              "Independent rule-based Minervini VCP Standard approximation results for the Nifty 500.",
            path: CANONICAL_SCANNER_PATH,
