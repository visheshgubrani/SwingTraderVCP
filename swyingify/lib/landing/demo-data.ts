...
export const ROADMAP_ROWS = [
  ...
  {
    name: "O'Neil",
    desc: "CAN SLIM-style trend and earnings leadership — educational guide while research continues.",
    status: "In research",
    live: false,
  ...
  {
    name: "Kullamägi",
    desc: "Momentum bases and tight-pullback breakouts — educational guide while research continues.",
    status: "In research",
    live: false,
  ...
  {
    name: "Darvas",
    desc: "Box theory and volume breakouts from a defined shelf — educational guide.",
    status: "In research",
    live: false,
  ...
  {
    name: "Livermore",
    desc: "Pivotal points and follow-through confirmation — educational guide.",
    status: "Queued",
    live: false,
